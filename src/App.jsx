...
function App() {
  return (
    <div className="flex flex-row min-h-screen bg-gray-700 text-gray-100">
        ...
        <div className="sidebar-content px-4 py-6">
          <ul className="flex flex-col w-full">
            ...
            <li className="my-px">
              <a
                href="#"
                className="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-gray-100"
              >
                <span className="flex items-center justify-center text-lg text-gray-400">
                  <svg
                    fill="none"
